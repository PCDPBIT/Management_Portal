      ...
      <div className="card-custom p-12 h-[calc(100vh-250px)] flex items-center justify-center">
        <div className="text-center text-gray-500">
          ...
          <p className="text-sm mt-2">
            Select a clause from the left panel to view or edit
          </p>
        </div>
      </div>
    );
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-200">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">
            Section {clause.section_no} • Last updated:{" "}
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setEditedClause({ ...editedClause, title: e.target.value })
                }
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-2">
                Use the toolbar to format text. Only approved formatting options
                are available.
              </p>
            </div>
          </div>
