...
function CurriculumMainPage() {
  ...
  const [editFormData, setEditFormData] = useState({ name: '', academic_year: '', max_credits: '' })
  ...
  const handleEditCurriculum = (e, curriculum) => {
    ...
    setEditFormData({ name: curriculum.name, academic_year: curriculum.academic_year, max_credits: curriculum.max_credits })
