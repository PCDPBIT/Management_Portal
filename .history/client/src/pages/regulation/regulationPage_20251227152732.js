...
function RegulationPage() {
  ...
  const handleDeleteRegulation = async (id) => {
    ...
    try {
      const response = await fetch(`http://localhost:8080/api/regulations/${id}`, {
        method: 'DELETE',
      })
      ...
      <div className="space-y-6">
        ...
        {showForm && (
          <div className="card-custom p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Create New Regulation</h3>
        ...
        {loading ? (
          ...
          <div className="card-custom p-12">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-500">Get started by creating a new regulation.</p>
              <button
                  ...
                  {regulations.map((reg) => (
                    <tr key={reg.id} className="hover:bg-gray-50 transition-colors duration-150">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm font-medium text-gray-900">{reg.code}</div>
                      </td>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div className="flex items-center justify-end space-x-3">
                          <button
                            onClick={() => navigate(`/regulation/${reg.id}/editor`)}
