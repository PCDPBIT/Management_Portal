...
- **Syllabus**:
  - Units (not Modules) 
  - NO: Objectives, Teamwork, Self-learning, Prerequisites
...
3. Frontend: Template dropdown in curriculum creation form
4. Frontend: Template field in state management

### 🚧 To Be Implemented (Next Steps)

#### 1. Update Backend Handlers

**File: `server/handlers/curriculum.go`**
- Update `CreateCurriculum` to accept and store `curriculum_template`
- Update `GetCurriculum` to return `curriculum_template`

**File: `server/handlers/curriculum_edit.go`**
- Update `UpdateCurriculum` to handle `curriculum_template` updates

#### 2. Conditional Course Creation Forms

**Files to modify:**
- `client/src/pages/semesterDetailPage.js`
- `client/src/pages/honourCardPage.js`
...
#### 3. Update Syllabus Page

**File: `client/src/pages/syllabusPage.js`**
