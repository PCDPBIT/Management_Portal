...
import (
	"net/http"
	handlers "server/handlers/curriculum"
...
func SetupRoutes() *mux.Router {
	...
	router.HandleFunc("/students", studentteacher.GetStudents).Methods("GET", "OPTIONS")
	router.HandleFunc("/students", studentteacher.CreateStudent).Methods("POST", "OPTIONS")
	router.HandleFunc("/students/{id}", studentteacher.GetStudent).Methods("GET", "OPTIONS")
	router.HandleFunc("/students/{id}", studentteacher.UpdateStudent).Methods("PUT", "OPTIONS")
	router.HandleFunc("/students/{id}", studentteacher.DeleteStudent).Methods("DELETE", "OPTIONS")
